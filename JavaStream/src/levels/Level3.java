...
public class Level3 {
    ...
    public static void main(String[] args) {
        ...
        Map<Integer, String> map1 = teachers.stream()
                .collect(Collectors.groupingBy(Teacher::getSalary, Collectors
                        .mapping(Teacher::getName, Collectors.joining(","))));
        /* TO DO 6: Afficher les nom des enseignants de chaque module */
        Map<Subject, List<String>> subjectNames = teachers.stream()
                .collect(Collectors.groupingBy(Teacher::getSubject,
